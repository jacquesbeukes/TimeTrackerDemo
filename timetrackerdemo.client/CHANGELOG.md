...
- Create Angular project with ng: `ng new timetrackerdemo.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`timetrackerdemo.client.esproj`).
